...
@section('content')
    ...
    <script>
        Echo.channel('chat') // Change channel name to 'chat'
            .listen('Chat', (e) => { // Adjust event name to 'Chat' to match your event class
                // Append the incoming message to the chat interface
